...
sdl_init_and_configure(bool display, const char *render_driver) {
...
#ifdef vcast_SDL_HAS_HINT_MOUSE_FOCUS_CLICKTHROUGH
...
#ifdef vcast_SDL_HAS_HINT_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR
    ...
    // Do not disable the screensaver when vcast is running
...
bool
vcast(const struct vcast_options *options) {

...
public class ScreenEncoder implements Device.RotationListener {
    ...
    public void streamScreen(Device device, FileDescriptor fd) throws IOException {
        ...
        try {
            ...
            // <https://github.com/KristiaN1337/vcast/issues/365>
            // <https://github.com/KristiaN1337/vcast/issues/940>
    ...
    private static MediaFormat createFormat(int bitRate, int maxFps, List<CodecOption> codecOptions) {
        ...
        if (maxFps > 0) {
            ...
            // <https://github.com/KristiaN1337/vcast/issues/488#issuecomment-567321437>
    ...
    private static IBinder createDisplay() {
        return SurfaceControl.createDisplay("vcast", true);
    }

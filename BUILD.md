...
Here are the instructions to build _vcast_ (client and server).
...
```bash
git clone https://github.com/KristiaN1337/vcast
cd vcast
```
...
[ninja-user]: https://github.com/KristiaN1337/vcast/commit/4c49b27e9f6be02b8e63b508b60535426bd0291a
...
After a successful build, you can install _vcast_ on the system:
...
This installs two files:
 ...
 - `/usr/local/bin/vcast`
 - `/usr/local/share/vcast/vcast-server`

Just remove them to "uninstall" the application.

You can then [run](README.md#run) _vcast_.


## Prebuilt server

 - [`vcast-server-v1.14`][direct-vcast-server]  
   _(SHA-256: 1d1b18a2b80e956771fd63b99b414d2d028713a8f12ddfa5a369709ad4295620)_

[direct-vcast-server]: https://github.com/KristiaN1337/vcast/releases/download/v1.14/vcast-server-v1.14
...
```bash
meson x --buildtype release --strip -Db_lto=true \
    -Dprebuilt_server=/path/to/vcast-server
ninja -Cx

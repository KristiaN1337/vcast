...
```bash
git clone https://github.com/KristiaN1337/scrcpy
cd scrcpy
```
...
[ninja-user]: https://github.com/KristiaN1337/scrcpy/commit/4c49b27e9f6be02b8e63b508b60535426bd0291a
...
[direct-scrcpy-server]: https://github.com/KristiaN1337/scrcpy/releases/download/v1.14/scrcpy-server-v1.14
